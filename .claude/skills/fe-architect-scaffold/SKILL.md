...
**Usar la convención definida en `CLAUDE.md` del proyecto** (español, prefijo + descripción breve). No usar Conventional Commits en inglés salvo indicación explícita.
